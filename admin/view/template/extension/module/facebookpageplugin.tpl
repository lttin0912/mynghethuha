  ...
  <div class="container-fluid">
                    ...
                    <div class="form-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <?php foreach ($stores  as $st) { ?>
                                ...
                                <li><a href="index.php?route=module/facebookpageplugin&store_id=<?php echo $st['store_id'];?>&token=<?php echo $token; ?>"><?php echo $st['name']; ?></a></li>
            ...
            <div class="panel-body">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"> 
                    ...
                    <input type="hidden" name="facebookpageplugin_status" value="1" />
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="main_settings" class="tab-pane fade"><?php require_once(DIR_APPLICATION.'view/template/'.$modulePath.'/tab_settings.php'); ?></div>

                            <div id="control_panel" class="tab-pane fade"><?php require_once(DIR_APPLICATION.'view/template/'.$modulePath.'/tab_controlpanel.tpl'); ?></div>
