...
class ControllerExtensionExtensionModule extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->load->controller('extension/module/' . $this->request->get['extension'] . '/_install_');
		...
		if ($files) {
			foreach ($files as $file) {
				...
				$data['extensions'][] = array(
					...
					'module'    => $module_data,
					'_install_'   => $this->url->link('extension/extension/module/_install_', 'token=' . $this->session->data['token'] . '&extension=' . $extension, true),
