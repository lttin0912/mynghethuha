...
class ControllerExtensionExtensionCaptcha extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			$this->load->controller('extension/captcha/' . $this->request->get['extension'] . '/_install_');
		...
		if ($files) {
			foreach ($files as $file) {
				...
				$data['extensions'][] = array(
					...
					'_install_'   => $this->url->link('extension/extension/captcha/_install_', 'token=' . $this->session->data['token'] . '&extension=' . $extension, true),
