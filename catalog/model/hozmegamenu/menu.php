					...
					if(isset($link[0])) 
					{
						...
						case 'CMS':
							...
							if(isset($cms['information_id'])) {
								...
								$this->_menuLink .= '<div id ="pt_menu_cms'.$cms['information_id'].'" class ="pt_menu pt_menu_link"><div class="parentMenu" ><a href="'.$cms_link.'"><span>'.$cms['title'].'</span></a></div></div>'.PHP_EOL;
							}
						break;
			}	
