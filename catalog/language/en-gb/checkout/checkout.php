...
$_['text_checkout_option']           = '<span class="number-title">1</span> Checkout Options';
$_['text_checkout_account']          = '<span class="number-title">2</span> Account &amp; Billing Details';
$_['text_checkout_payment_address']  = '<span class="number-title">2</span> Billing Details';
$_['text_checkout_shipping_address'] = '<span class="number-title">3</span> Delivery Details';
$_['text_checkout_shipping_method']  = '<span class="number-title">4</span> Delivery Method';
$_['text_checkout_payment_method']   = '<span class="number-title">5</span> Payment Method';
$_['text_checkout_confirm']          = '<span class="number-title">6</span> Confirm Order';
