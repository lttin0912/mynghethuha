...
<!--       <h1><?php echo $heading_title; ?>
       ...
       <div class="module-title title-top "><h3 class="title-group"><?php echo $heading_title; ?><?php if ($weight) { ?>
        &nbsp;(<?php echo $weight; ?>)
        <?php } ?></h3></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center qty-checkout-cart"><div class="input-group btn-block text-center" >
                    <div class="input-checkout-cart"><input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" class="form-control checkout-cart" /></div>
		...
		<?php if ($modules) { ?>
		<div class="module-title title-top "><h3 class="title-group"><?php echo $text_next; ?></h3></div>
