...
<div class="img-category">
	...
	<?php } ?>
	<?php if ($description) { ?>
		<div class="hidden"><?php echo $description; ?></div>
	<?php } ?>
		...
		<div class="custom-category">
			<div class="product-filter">
				<div class="btn-group">
					...
					<button type="button" id="list-view" class="btn btn-default"  title="<?php echo $button_list; ?>"><i class="fa fa-th-list"></i></button>				</div>
				<div class="sort">
								...
								<div class="item-inner">
									...
									<div class="caption des-container">
										...
										<?php if (isset($product['rating'])) { ?>
											<div class="rating"><img src="catalog/view/theme/tt_grand1/image/stars-<?php echo $product['rating']; ?>.png" alt="#" /></div>
										<?php } ?>
