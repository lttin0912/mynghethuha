<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block btn-lg dropdown-toggle"><em class="lnr lnr-cart"></em> <span id="cart-total"><?php echo $text_items; ?></span></button>
