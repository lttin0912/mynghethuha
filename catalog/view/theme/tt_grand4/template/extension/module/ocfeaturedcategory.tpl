...
<div class="categories-title"><h2><?php echo $title; ?></h2></div>
	<?php
        $count = 0;
			...
			<?php if($count++ % $rows == 0 ) { echo '<div class="row_items">'; } ?>
				<div class="fcategory-content">
					<div class="image-thumb">
						<a class="home-thumb" href="<?php echo $category['href']; ?>"><img src="<?php echo $category['homethumb_image'] ?>" alt="" /></a>
						<a class="hover-thumb" href="<?php echo $category['href']; ?>"><img src="<?php echo $category['thumbnail_image'] ?>" alt="" /></a>
					</div>
